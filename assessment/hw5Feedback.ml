 ...
 * 4.1.a: 2/2
 * 4.1.b: 3.5/4
 -0.5: LHS for inductive step has a type. It should be rev x'::L1 L2
 * 4.1.c: 2/2
 *)
 ...
 * Problem 4.2 (c): 1.5/2
 * Total: 7.5/8
 * Comments: (b) next time, state that by mathematical property 0+x=x, so length lst2 = length lst2
 * (c) incorrect use of lemma in part b to show part c
 *)
