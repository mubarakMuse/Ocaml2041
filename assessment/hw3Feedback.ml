...
(*
  Problem 3.1: 2/4
	-2: no detailed explanation for how to get result for each step
 *)
...
*)
(* 2/4
 * You need to give an explanation about how you get to each of these types
 *)
