 ...
 * Problem 1.1
 * Score: 2.5/3
 * Comments: sqr would be evaluated after take
 *)
...
problem 3.1
2/2: mkStream'
2/2: nextStream' (Evald)
2/2: nextStream' (UnEvald)
*)
...
(* SCORE (Problem 2.2, natStream') : 3/3
 *		+3 : correct definition of natStream'
 *)
